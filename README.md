...
- [2. Theoretische Grundlagen](#theoretische-grundlagen)
  - [2.1 Systemhärtung und Compliance](#systemhaertung-und-compliance)
  - [2.2 SCAP-Standard](#scap-standard)
  - [2.3 OpenSCAP – Funktionsweise und Nutzen](#openscap--funktionsweise-und-nutzen)
  - [2.4 Ansible als Automatisierungsframework](#ansible-als-automatisierungsframework)
  - [2.5 Vergleich mit alternativen Frameworks und Begründung der Wahl](#vergleich-mit-alternativen-frameworks-und-begruendung-der-wahl)
    - [2.5.1 Vergleich von Security- und Compliance-Frameworks](#vergleich-von-security--und-compliance-frameworks)
    - [2.5.2 Vergleich von Automatisierungs-Frameworks](#vergleich-von-automatisierungs-frameworks)
    - [2.5.3 Begründung der Wahl](#begruendung-der-wahl)
- [3. Analyse der OpenSCAP-Profile](#analyse-der-openscap-profile)
  - [3.1 Übersicht verfügbarer SCAP-Profile](#uebersicht-verfuegbarer-scap-profile)
  - [3.2 Bewertung und Vergleich der Profile](#bewertung-und-vergleich-der-profile)
  - [3.3 Auswahl und Empfehlung](#auswahl-und-empfehlung)
- [4. Methodik und Umsetzung](#methodik-und-umsetzung)
  - [4.1 Testumgebung und Infrastruktur](#testumgebung-und-infrastruktur)
  - [4.2 Workflow: Scan, Reporting und Remediation](#workflow-scan-reporting-und-remediation)
  - [4.3 Automatisierte Umsetzung mit Ansible](#automatisierte-umsetzung-mit-ansible)
- [5. Ergebnisse und Auswertung](#ergebnisse-und-auswertung)
  - [5.1 Vorher-/Nachher-Analyse](#vorher-nachher-analyse)
  - [5.2 Auszüge aus OpenSCAP-Reports](#auszuege-aus-openscap-reports)
  - [5.3 Ansible-Playbook für automatisierte Härtung](#ansible-playbook-fuer-automatisierte-haertung)
  - [5.4 Bewertung der Ergebnisse](#bewertung-der-ergebnisse)
- [6. Fazit und Ausblick](#fazit-und-ausblick)
  - [6.1 Ausblick](#ausblick)
